...
It lives inside the package so that there is one way to start the program and
three ways to say it: the `vollama` command, `python -m vollama`, and the
`VOLlama.py` at the repository root that PyInstaller is pointed at.
"""
